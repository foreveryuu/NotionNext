...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1a0bfea66af94d68aaaad316f49fc265,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  GREETING_WORDS:
    ...
    'Hi，I am forever, Welcome to my blog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Forever', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '这是一个作者简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '这里是网址', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '关键词1, 关键词2', // 网站关键词 英文逗号隔开
  ...
  FONT_URL: [
    ...
    "https://fonts.googleapis.com/css2?family=Noto+Serif+TC:wght@200..900&display=swap",
